...
import { mapQrPassApiError } from "@/lib/api/qr-pass-errors";
...
import { revokeQrPassLifecycle } from "@/server/services/event-qr-pass-lifecycle.service";
...
/**
 * Blueprint 7.3R — revoke a QR pass.
 * POST .../qr-passes/{passId}/revoke
 */
export async function POST(request: Request, context: RouteContext) {
  ...
  try {
    ...
    const result = await revokeQrPassLifecycle(
      {
