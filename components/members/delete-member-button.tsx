...
import { deleteMemberAction } from "@/app/(staff)/member/actions";
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/40 px-4">
          ...
          >
            ...
            <p className="mt-2 text-sm text-zinc-600 dark:text-zinc-300">
              This permanently deletes {memberName}. Prefer Archive for ordinary
              lifecycle management. Permanent deletion is restricted to Super
              Admin and cannot be undone.
            </p>
            {error ? (
